...
import { dofetchdatac, dofetchdatawithtokenc, doupdateprofilec } from "./consprofile_controller"

export default function Consprofile() {
    ...
    async function dofetchdata() {
        ...
        try {
            if (userData) {
                ...
                const encodedppic = encodeURIComponent(userData.ppic);
        ...
        <form className="mx-auto w-9/12 flex-col justify-center" >
            <div className="space-y-12 ">
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-4xl p-8 font-semibold leading-7 text-gray-900">Consumer Profile</h2>
                            ...
                            <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                <div className="text-center">
                                    ...
                                    <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                        <label
                                            htmlFor="file-upload"
                                            className="relative cursor-pointer rounded-md bg-white font-semibold text-lge focus-within:outline-none focus-within:ring-2 focus-within:ring-lge focus-within:ring-offset-2 hover:text-ge"
                                        >
                        ...
                        <div className="sm:col-span-full">
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    onChange={doUpdate}
                                    value={obj.name}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-lge sm:text-sm sm:leading-6"
                                />
                            </div>
                        </div>
